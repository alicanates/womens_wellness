...
### 🤖 AI Yapılandırması
- Model politikaları (Ücretsiz/Premium)
...
│   ├── providers/
│   │   ├── authProvider.ts    # Kimlik doğrulama
│   │   └── dataProvider.ts    # API entegrasyonu
│   └── lib/
│       └── translations.ts    # Türkçe çeviriler
├── .env.example
├── .env.local
├── package.json
└── README.md
...
- `GET /feature-flags` - Özellik bayrakları
