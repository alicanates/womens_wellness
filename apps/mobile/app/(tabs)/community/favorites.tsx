...
import { useFavoriteQuestions } from '@/hooks/useQna';
import {
    QuestionCard,
...
export default function FavoritesScreen() {
    ...
    const { data: questionsData, isLoading, error, refetch } = useFavoriteQuestions(1, 20);
            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subtitle}>
                            Favori olarak işaretlediğiniz sorular
                        </Text>
                        {questions.length > 0 && (
                ...
                ListEmptyComponent={
                    isLoading ? (
                        ...
                        <EmptyState
                            type="favorites"
                            message="İlginizi çeken soruları favorilere ekleyerek daha sonra kolayca erişebilirsiniz"
                        />
                    )
                }
